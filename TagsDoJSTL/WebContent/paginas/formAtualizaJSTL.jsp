		...
		<table>
			<tr>
				...
				<td><input type="text" name="isbn"
					value="<c:out value="${row.isbn}" />" readonly="readonly" /></td>
			</tr>
			<tr>
				<td>Título:</td>
				<td><input type="text" name="titulo"
					value="<c:out value="${row.titulo}" />" /></td>
			</tr>
			<tr>
				<td>Edição:</td>
				<td><input type="text" name="edicao"
					value="<c:out value="${row.edicao_num}" />" /></td>
			</tr>
			<tr>
				<td>Publicação:</td>
				<td><input type="text" name="publicacao"
...
pattern="yyyy"/>" />
			...
			<tr>
				<td>Descrição:</td>
				<td><textarea name="descricao" rows="5" cols="25">
<c:out value="${row.descricao}" />
					</textarea></td>
			</tr>
			<tr>
				<td colspan="2"><input type="submit" name="btAtualizar"
					value="Atualizar" /></td>
			</tr>
		</table>
	</form>
